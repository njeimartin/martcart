...
export default async function HomePage(){
  ...
  return <main className="triggers-site">
    ...
    <section className="trigger-hero"><div className="trigger-container hero-overlay">
      ...
      <div className="trigger-buttons"><Link className="trigger-btn gold" href="/shop">SHOP NOW →</Link><a className="trigger-btn outline" href="#categories">EXPLORE COLLECTION</a></div>
    </div></section>
